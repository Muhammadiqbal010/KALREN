...
const SidebarAdmin = () => {
  ...
  const menuItems = [
    { name: 'Dashboard',         path: '/admin',           icon: '📊', ownerOnly: false },
    { name: 'Inventory / Product', path: '/admin/products', icon: '👕', ownerOnly: false },
    { name: 'CMS Settings',      path: '/admin/cms',        icon: '🏠', ownerOnly: false },
    { name: 'Lookbook Panel',    path: '/admin/lookbook',   icon: '📸', ownerOnly: false },
    { name: 'Analytics Data',    path: '/admin/stats',      icon: '📈', ownerOnly: false },
    { name: 'Stock Bahan',       path: '/admin/inventory',  icon: '📦', ownerOnly: true  },
    { name: 'Master Bahan',   path: '/admin/inventory/master', icon: '🗂', ownerOnly: true },
    { name: 'Keuangan',          path: '/admin/finance',    icon: '💰', ownerOnly: true  },
    { name: 'Profile',           path: '/admin/profile',    icon: '👤', ownerOnly: false },
  ];

  // Filter menu: ownerOnly hanya tampil jika role === 'owner'
            ...
            >
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-neutral-400 font-medium leading-relaxed px-2">
                  Apakah kamu yakin ingin keluar dari panel admin? Sesi aktif
                  akan diakhiri dan kamu harus login kembali untuk masuk.
                </p>
              </div>
