      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          try {
            ...
            execSync(`git -c user.name="Muhammad-Iqbal" -c user.email="muhammadiiqbal31@gmail" add "${targetFile}"`);;
            execSync(`git -c user.name="Muhammad-Iqbal" -c user.email="muhammadiiqbal31@gmail" commit -m "visual_edit_${timestamp}"`);
          } catch (gitError) {
